/*
* @Author: yueyataihen
* @Date:   2017-12-15 10:53:55
* @Last Modified by:   yueyataihen
* @Last Modified time: 2017-12-15 14:13:22
*/
'use strict';

var _cities = {
	cityInfo : {
		'北京':['北京','东城区','西城区','崇文区','宣武区','朝阳区','丰台区','石景山区',' 海淀区（中关村）','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','密云县','延庆县','其他'],
		'上海':['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区','崇明县','其他'],
		'天津':['和平区','河东区','河西区','南开区','红桥区','塘沽区','汉沽区','大港区','西青区','津南区','武清区','蓟县','宁河县','静海县','其他'],
		'重庆':['重庆'],
		...
		'广西':['南宁市','桂林市','柳州市','梧州市','贵港市','玉林市','钦州市','北海市','防城港市','崇左市','百色市','河池市','来宾市','贺州市','其他'],
		'海南省':['海口市','三亚市','其他'],
		...
		'云南省':['昆明市','曲靖市','玉溪市','保山市','昭通市','丽江市','普洱市','临沧市','宁德市','德宏傣族景颇族自治州','怒江僳僳族自治州','楚雄彝族自治州','红河哈尼族彝族自治州','文山壮族苗族自治州','大理白族自治州','迪庆藏族自治州','西双版纳傣族自治州','其他'],
		...
		'新疆':['乌鲁木齐市','克拉玛依市','喀什地区','阿克苏地区','和田地区','吐鲁番地区','哈密地区','塔城地区','阿勒泰地区','克孜勒苏柯尔克孜自治州','博尔塔拉蒙古自治州','昌吉回族自治州 伊犁哈萨克自治州','巴音郭楞蒙古自治州','河子市','阿拉尔市','五家渠市','图木舒克市','其他'],
		'香港':['香港'],
		'澳门':['澳门'],
		'台湾省':['台北','台南','其他'],
	},
